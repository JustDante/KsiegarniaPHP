        ...
        <a href="index.php">
            <div id="header">
                ...
                <div>
                    ...
                    <h3 style="float:right; margin:10px;font-size:1.5vw; background-color:#f13c0e; width:300px; border-radius:15px;"> Zobacz aktualne zamówienie </h3>
                    </a>
            ...
            <div id="content">
                ...
                <h2>Kategorie</h2>
                    <ul>
                        <li><a href="order_page.php"> Fantasy </a></li>
